...
public class VectorImpl_EventListener_ChangeEvent__long_
  implements Vector_EventListener_ChangeEvent__long_,
             VectorOptimized<EventListener_ChangeEvent_>,
             Dumpable,
             ManagedResource
 {
    private java.util.Vector vector;

    protected VectorImpl_EventListener_ChangeEvent__long_ (CallContext context) {
        vector = new java.util.Vector(4);
    }

    static public VectorImpl_EventListener_ChangeEvent__long_ create (CallContext context) {
        return new VectorImpl_EventListener_ChangeEvent__long_(context);
    }

    protected VectorImpl_EventListener_ChangeEvent__long_ (CallContext context, java.util.Vector vector) {
        this.vector = vector;
    }

    static public VectorImpl_EventListener_ChangeEvent__long_ create (CallContext context, java.util.Vector vector) {
        return new VectorImpl_EventListener_ChangeEvent__long_(context, vector);
    }
    ...
    public EventListener_ChangeEvent_ get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (EventListener_ChangeEvent_) vector.elementAt((int) index);
    ...
    public EventListener_ChangeEvent_ set          (CallContext context, long index, EventListener_ChangeEvent_ item) {
        ...
        return (EventListener_ChangeEvent_) vector.set((int) index, item);
    }
    ...
    public void     prepend      (CallContext call_context, EventListener_ChangeEvent_ item) {
        if (vector.size() == 0) {
            vector.add(item);
        } else {
            try {
    ...
    public EventListener_ChangeEvent_ replace      (CallContext call_context, long index, EventListener_ChangeEvent_ item) throws DoesNotExist {
        try {
            return (EventListener_ChangeEvent_) vector.set((int) index, item);
        } catch (ArrayIndexOutOfBoundsException e) {
    ...
    public EventListener_ChangeEvent_ unset        (CallContext context, long index) {
        try {
            return (EventListener_ChangeEvent_) vector.remove((int) index);
        } catch (ArrayIndexOutOfBoundsException e) {
    ...
    public boolean contains(CallContext context, EventListener_ChangeEvent_ item) {
        return this.vector.contains(item);
    }

    public boolean removeFirst(CallContext context, EventListener_ChangeEvent_ item) {
        return this.vector.remove(item);
    }

    public void removeAll(CallContext context, EventListener_ChangeEvent_ item, VectorOptimized.Notifier<EventListener_ChangeEvent_> notifier) {

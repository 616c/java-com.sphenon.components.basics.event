...
public class VectorImplList_EventListener_ChangeEvent__long_
  implements Vector_EventListener_ChangeEvent__long_, VectorImplList, Dumpable, ManagedResource {
    protected java.util.List vector;

    protected VectorImplList_EventListener_ChangeEvent__long_ (CallContext context) {
        vector = new java.util.ArrayList ();
    }

    static public VectorImplList_EventListener_ChangeEvent__long_ create (CallContext context) {
        return new VectorImplList_EventListener_ChangeEvent__long_(context);
    }

    protected VectorImplList_EventListener_ChangeEvent__long_ (CallContext context, java.util.List vector) {
        this.vector = vector;
    }

    static public VectorImplList_EventListener_ChangeEvent__long_ create (CallContext context, java.util.List vector) {
        return new VectorImplList_EventListener_ChangeEvent__long_(context, vector);
    }

    public EventListener_ChangeEvent_ get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (EventListener_ChangeEvent_) vector.get((int) index);

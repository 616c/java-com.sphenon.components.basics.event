...
public class VectorReferenceToMember_EventListener_ChangeEvent__long_
    implements ReferenceToMember_EventListener_ChangeEvent__long_ReadOnlyVector_EventListener_ChangeEvent__long__
{
    private ReadOnlyVector_EventListener_ChangeEvent__long_ vector;
    private long                          index;

    public VectorReferenceToMember_EventListener_ChangeEvent__long_ (CallContext context, ReadOnlyVector_EventListener_ChangeEvent__long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public EventListener_ChangeEvent_ get (CallContext context) {
            try {
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_EventListener_ChangeEvent__long_)) return false;
        if (((VectorReferenceToMember_EventListener_ChangeEvent__long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_EventListener_ChangeEvent__long_) object).index  != this.index ) return false;
        return true;
    }

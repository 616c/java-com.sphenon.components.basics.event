...
public class SetImpl_WeakReference_EventListener_ChangeEvent___
  implements Set_WeakReference_EventListener_ChangeEvent___
{
    private java.util.Hashtable map;

    public SetImpl_WeakReference_EventListener_ChangeEvent___ (CallContext context)
    {
    }
    ...
    public SetImpl_WeakReference_EventListener_ChangeEvent___ (CallContext context, java.util.Hashtable map)
    {
        this.map = map;
    }
    ...
    {
        initialise(context);
        return new SetIteratorImpl_WeakReference_EventListener_ChangeEvent___ (context, map);
    }

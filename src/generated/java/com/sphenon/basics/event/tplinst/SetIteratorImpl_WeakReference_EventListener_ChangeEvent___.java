...
public class SetIteratorImpl_WeakReference_EventListener_ChangeEvent___
    implements Iterator_WeakReference_EventListener_ChangeEvent___
{
    private java.util.Hashtable map;
    private java.util.Set entry_set;
    private java.util.Iterator iterator;
    private WeakReference_EventListener_ChangeEvent__ current;

    public SetIteratorImpl_WeakReference_EventListener_ChangeEvent___ (CallContext context, java.util.Hashtable map) {
        this.map = map;
        ...
        if (this.iterator.hasNext()) {
            ...
            this.current = (WeakReference_EventListener_ChangeEvent__) me.getValue();
        } else {
            this.current = null;
        }
    }
    ...
    public WeakReference_EventListener_ChangeEvent__ getCurrent    (CallContext context) throws DoesNotExist
    {
        if (this.current == null) DoesNotExist.createAndThrow(context);
        return this.current;
    }

    public WeakReference_EventListener_ChangeEvent__ tryGetCurrent (CallContext context)
    {
        return this.current;
    }
    ...
    public SetIteratorImpl_WeakReference_EventListener_ChangeEvent___ clone(CallContext context) {
